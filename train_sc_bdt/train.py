...
# Config
# ============================================================
DATA_DIR = "./swqq_dataset"
OUT_DIR = "./swqq_bdt_output"
RANDOM_SEED = 42
...
def main():
    ...
    print(f"[INFO] Weighted W-like fraction (train) = {sum_w_pos / max(sum_w_pos + sum_w_neg, 1e-12):.6f}")
    ...
    # save model
    model_json_path = os.path.join(OUT_DIR, "bdt_swqq_model.json")
    model_pkl_path = os.path.join(OUT_DIR, "bdt_swqq_model.pkl")
